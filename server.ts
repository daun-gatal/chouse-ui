...
// Parse multiple URLs from VITE_CLICKHOUSE_URLS (comma separated)
const rawUrls = process.env.VITE_CLICKHOUSE_URLS || "";
...
if (clickhouseUrls.length > 0) {
    ...
    console.log("No VITE_CLICKHOUSE_URLS configured. Proxy disabled.");
}
