ClickHouse optimization playbook — when you recommend a fix for a heavy/slow query or its schema, ground it here and name the pattern/rule. Patterns compound (combining several can be 50-100×).
