...
import { rbacUsersApi, rbacRolesApi, type RbacRole, type CreateUserInput } from "@/api/rbac";
        ...
        <div className="space-y-6">
          ...
          <div className="overflow-hidden rounded-xs border border-ink-500 bg-ink-100">
            ...
            <div className="space-y-2 px-5 py-4 text-[12px]">
              ...
              <div className="flex items-start justify-between gap-3">
                <span className="font-mono text-[10px] uppercase tracking-[0.14em] text-paper-dim">Data access</span>
                <span className="text-right text-paper-muted">Granted by the assigned role's policies</span>
              </div>
            </div>
          </div>
        </div>
